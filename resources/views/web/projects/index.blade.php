      ...
      <div class="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div class="text-center mb-24">
              <h1 class="text-4xl font-extrabold text-slate-900 dark:text-white">
                  Semua Project <span class="bg-gradient-to-r from-green-600 via-emerald-500 to-teal-400 bg-clip-text text-transparent">LIRADIGI.</span>
              </h1>
              <p class="mt-4 mb-4 text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
                  Jelajahi seluruh karya yang telah kami hasilkan untuk berbagai brand dan bisnis.
              </p>
          </div>
        ...
        <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="group relative overflow-hidden rounded-2xl shadow-lg bg-white dark:bg-slate-800
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition">
                    <div class="absolute bottom-6 left-6 right-6 text-white">
                        <h3 class="text-xl font-bold">{{$project->name}}</h3>
                        <p class="text-sm text-slate-200 line-clamp-3">{!! Purify::clean($project->description) !!}</p>
