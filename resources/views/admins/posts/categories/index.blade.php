                ...
                <div class="card info-card customers-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-sm btn-primary" href="{{route('posts.categories.create')}}">Add</a>
                        </div>
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('posts.categories.edit', $category->id)}}" class="btn btn-sm btn-warning">
                                            <i class="bi bi-pen"></i>
                                        </a>
                                        <form action="{{route('posts.categories.destroy', $category->id)}}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
